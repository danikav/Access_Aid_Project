    ...
    <>
      <div className="location-list-item">
        ...
        <div className="location-info">
          <h2>{location.name}</h2>
          <p>Overall Rating: <Rating className="rating" emptySymbol={<span>&#9734;</span>} fullSymbol={<span>&#9733;</span>} initialRating={averages.total_score} fractions={2} readonly /></p>
          ...
          <ul>
            ...
            <li>Low Noise Level: <Rating className="rating" emptySymbol={<span>&#9734;</span>} fullSymbol={<span>&#9733;</span>} initialRating={averages.low_noise_score} fractions={2} readonly /></li>
            <li>High Light Level: <Rating className="rating" emptySymbol={<span>&#9734;</span>} fullSymbol={<span>&#9733;</span>} initialRating={averages.high_light_score} fractions={2} readonly /></li>
